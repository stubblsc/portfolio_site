...
class ArtsControllerTest < ActionController::TestCase
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post :create, art: { description: @art.description, medium: @art.medium, subsection_id: @art.subsection_id, title: @art.title }
    end
  ...
  test "should update art" do
    patch :update, id: @art, art: { description: @art.description, medium: @art.medium, subsection_id: @art.subsection_id, title: @art.title }
    assert_redirected_to art_path(assigns(:art))
  end
